...
enum RV32Asm {
    ...
    static func lbu(_ rd: Int, _ offset: Int32, _ rs1: Int) -> UInt32 {
        load(rd, offset, rs1, funct3: 4)
    }

    static func sw(_ rs2: Int, _ offset: Int32, _ rs1: Int) -> UInt32 {
        store(rs2, offset, rs1, funct3: 2)
    }

    static func sb(_ rs2: Int, _ offset: Int32, _ rs1: Int) -> UInt32 {
    ...
    static func beq(_ rs1: Int, _ rs2: Int, _ offset: Int32) -> UInt32 {
        branch(rs1, rs2, offset, funct3: 0)
    }

    static func bne(_ rs1: Int, _ rs2: Int, _ offset: Int32) -> UInt32 {
    ...
    static func jal(_ rd: Int, _ offset: Int32) -> UInt32 {
        let imm = UInt32(bitPattern: offset)
    ...
    static func csrw(_ csr: UInt32, _ rs1: Int) -> UInt32 {
        (csr << 20) | (UInt32(rs1) << 15) | (1 << 12) | 0x73
    }

    static let mret: UInt32 = 0x3020_0073
    ...
    static func image(_ words: [UInt32]) -> Data {
